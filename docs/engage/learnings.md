...
**Curva de FRUTA (calc. 10/08):** Ene 5 · Feb 6 · Mar 14 · Abr 15 · May 14 · Jun 8 · Jul 6 · **Ago 3** · Set 2 · Oct 3 · Nov 2 · Dic 6. ⚠️ **Agosto NO es el mínimo del año** (set y nov tienen 2) — el hallazgo correcto es el **3 → 2**: mandarina B-24 (abr-ago) cierra y quedan limonero B-23 (12/12, el único perpetuo) + palta Haas B-36 (may-oct).
